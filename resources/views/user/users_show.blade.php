...
<html lang="en">
  ...
  <body>
    ...
    <canvas id="particle-canvas"></canvas> <!-- background animado -->
        ...
        <!-- Title Card -->
        <center>
          <div class="card hover" style="width: 14rem;">
            <img src="http://localhost/proj_Final/public/icons/usericon.png" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">{{$user->name}}</h5>
              <p class="card-text"><b>ID:</b> {{$user->id}}</p>
              <p class="card-text"><b>Email:</b> {{$user->email}}</p>
              <p class="card-text"><b>Criado em:</b> {{$user->created_at}}</p>
            </div>
          </div>
        </center>
