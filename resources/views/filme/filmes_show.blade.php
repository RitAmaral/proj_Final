...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        .comentario-item {
            margin-bottom: 20px; /* Espaçamento inferior entre os comentários */
            border: 1px solid #ddd; /* Borda para separar os comentários */
            padding: 10px;
            background-color: #f9f9f9; /* Cor de fundo dos comentários */
        }
    ...
    <body>
        <div class="back">
            <a type="button" href="{{ route('filme.index') }}" class="btnback">Voltar aos Filmes</a>   
        </div>
